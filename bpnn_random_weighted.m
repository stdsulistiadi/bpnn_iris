...
%weight initiation with random function -0.5 to 0.5
%v=rand(input_col_length,hidden_neuron)-ones(input_col_length,hidden_neuron)/2; %random generator
%w=rand(hidden_neuron,target_col_length)-ones(hidden_neuron,target_col_length)/2; %random generator
v=[0.13584,0.44908,0.1821,-0.13186,-0.13426,-0.47506,-0.069266,-0.16609;0.11365,-0.26384,0.43592,-0.23005,-0.060468,-0.26275,-0.17408,0.3864;-0.3889,0.045244,-0.17555,-0.39076,-0.40095,0.33539,0.0007694,0.32386;-0.24343,0.45307,0.054626,-0.24773,-0.080212,-0.19976,-0.33229,-0.49412]; %given
w=[0.26872,0.2447,-0.37297;0.06159,-0.17709,-0.37387;0.46636,0.12208,0.23246;0.22421,0.041961,-0.11212;-0.084065,0.06204,-0.37405;-0.014748,-0.13326,0.34871;-0.39181,0.41488,-0.10076;0.27049,-0.48182,-0.20509]; %given

%bias initiation with random function -0.5 to 0.5
%v_bias=rand(1,hidden_neuron)-ones(1,hidden_neuron)/2; %random generator
%w_bias=rand(1,target_col_length)-ones(1,target_col_length)/2; %random generator
%v_bias=[[0.15475,0.003935,0.23064,0.44855,0.077605,-0.42567,-0.31525,0.0067297]]; %given
%w_bias=[-0.17356,-0.31829,-0.29239]; %given
